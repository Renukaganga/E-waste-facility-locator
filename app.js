...
const twilioClient = twilio('ACbead2ad03c0ac313b250b57a745ce88f', 'd8ad2d819cab1a8ecc2e246b0275c65e');
...
app.post('/grantcreditpoints' , async(req , res) => {
    ...
    user.Successful.push({plantName : ewplant.Name , creditPoints : parseInt(req.body.creditpts) , cash : parseInt(req.body.money)});
    await user.save();
...
app.post('/confirm-pickup', async (req, res) => {
    ...
    //  Send a confirmation SMS
      const message = await twilioClient.messages.create({
        body: `Your e-waste pickup has been confirmed`,
        from: '+15714021899',
